...
public class CustomerController {
    ...
    // public ResponseEntity<Customer> retrieveAdminProfile() {
    //     Customer customer = customerService.getCustomerProfile();
    //     return new ResponseEntity<>(customer, HttpStatus.OK);
    // }
    ...
    public ResponseEntity<Customer> handleCustomerResetPassword (HttpServletRequest request, @RequestParam(required = false, defaultValue = "unknown") String username){
    ...
    private String getAppUrl(HttpServletRequest request) {
        String appURL = request.getServerPort() == -1 ? 
