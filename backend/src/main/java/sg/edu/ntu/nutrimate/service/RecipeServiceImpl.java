...
public class RecipeServiceImpl implements RecipeService {
    ...
    public ApiResponse getAllRecipes() {
        String recipeData = spoonacularService.getRecipes("any");
        ...
        try {
            ...
            response = mapper.readValue(recipeData, ApiResponse.class);
    ...
    public RecipeServiceImpl(RecipeRepository recipeRepository, CustomerRepository customerRepository, AuthenticationService authenticationService) {
    ...
    @Override
    public CustomerRecipe uploadCustomerRecipe(CustomerRecipe recipe) {

        Customer authenticatedCustomer = authenticationService.getAuthenticatedCustomer();
        
        String userID = authenticatedCustomer.getUserID();
