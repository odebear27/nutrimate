...
import sg.edu.ntu.nutrimate.service.AuthenticationService;
import sg.edu.ntu.nutrimate.service.AuthenticationServiceImpl;
...
public class RecipeServiceImplTest {
    ...
    public void uploadRecipeTest() {
        ...
        "Chicken rice is a Singapore local dish.", 30, "Asian", "www.testURL.com.sg", "", customer1);

        when(authenticationService.getAuthenticatedCustomer()).thenReturn(customer1);
        ...
        // Act
        CustomerRecipe savedCustomerRecipe = recipeService.uploadCustomerRecipe(newCustomerRecipe);
    ...
    public void updateRecipeTest() {
        ...
        // Act
        CustomerRecipe savedCustomerRecipe = recipeService.updateRecipe(1, updatedCustomerRecipe);
    ...
    public void getAllCustomerRecipesByUserID() {
        ...
        // Act
        List<CustomerRecipe> foundRecipes = recipeService.getAllCustomerRecipesByUserID();
